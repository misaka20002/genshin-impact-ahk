...
#if WinActive("ahk_exe Game.exe") or WinActive("ahk_exe Game_zh-CN.exe")
...
~v:: ;按一下v就连按z，再按一下v取消
; if WinActive("ahk_exe Game_zh-CN.exe") or WinActive("ahk_exe Game.exe")
{
if(vSwitch==0)
{
SetTimer, loopzbutton, 100
vSwitch=1
}
else if(vSwitch==1)
{
SetTimer, loopzbutton, Off
vSwitch=0
}
}
return
...
loopzbutton:
{
	Random, vloopPeriod, 300, 350
	SetTimer, loopzbutton, %vloopPeriod% ;引入随机数反作弊（聊胜于无
	Send {z down}
	...
	Loop
        {
                ...
                Break
				Send {z down}
				Sleep 50 ; try various milliseconds
				Send {z up}
