...
ReloadByStartGameFromHere:
  ...
  ;用户设定config：
  ;游戏路径
  game_Name=HTGame.exe ;国际服请修改此处为genshin.exe

  ; 异环 原生
  run_exe_local=F:\Neverness To Everness\ ;自动启动exe的路径
  run_exe_name=NTELauncher.exe ;自动启动exe ; 米哈游启动器
  ...
  ; 异环 Mod 启动器 https://github.com/CHN-HelloWorld/GIML
  ...
  help2001=异环AHK帮助`n`n    键盘功能：`n    Home——启动/暂停本软件`n    F3——媒体播放/暂停`n    长按F键——F键连击`n    双击F键——开启持续鼠标左键连点`n    x键/~键——持续按w前进`n    双击w键——持续按w前进`n    Tab键——异环游戏内的○确定键`n    ESC键——点击对话时最下选项`n    ctrl+F9——5个探索派遣`n    请在异环设置将落下键改为n，或启动本软件双击x下落`n`n    鼠标功能：`n    鼠标中键——开启持续鼠标左键连点`n    鼠标侧键1——按w键`n    双击鼠标侧键1——持续按w前进`n    鼠标侧键2——按F键`n    长按鼠标侧键2——连击F键`n    双击并长按鼠标侧键2——ALT键（显示鼠标/快捷元素爆发）
  ...
  ; 变量
  xh=1
  ;是否禁用esc键，禁用派蒙菜单 用于卡bug卡出派蒙后不要让派蒙消失
  kalepaimon=0
  ...
  if (v_isReloadByStartGameFromHere==0)
  {
    if(A_IsAdmin)
    {
      ; MsgBox, 4, , %help2001%`n`n%helpyouxiyiqidong%启动异环游戏, 分辨率:(%OutWidth%,%OutHeight%), Pos:(%OutX%,%OutY%),%b_UseFindText%`n(游戏启动后或窗口位置发生变化请重启本软件)`n    Ctrl+Home——重启本软件`n    问：是否不开启"屏蔽ESC键"：卡出了派蒙跟随后点'否'
      MsgBox, 4, , %help2001%`n`n%helpyouxiyiqidong%启动异环游戏, 分辨率:(%OutWidth%,%OutHeight%), Pos:(%OutX%,%OutY%),%b_UseFindText%`n(游戏启动后或窗口位置发生变化请重启本软件)`n    Ctrl+Home——重启本软件
      IfMsgBox yes
      {
        kalepaimon=0
      }
      ...
      if !WinExist(yuanshenName)
      {
        MsgBox, 4, ,异环未启动，是否启动异环？`n  （编辑本ahk文件设置异环路径）
        IfMsgBox, yes
        {
    ...
    if not (A_IsAdmin or RegExMatch(full_command_line, " /restart(?!\S)"))
    {
      ...
      {
        MsgBox, 4, , 大侠，你异环是用管理员权限启动的，`n本软件需要用管理员权限才可以在你异环内执行模拟键鼠功能。`n`n是否授予管理员权限？`n（建议以后使用快捷方式-高级-勾选以管理员运行）`n`n是：重启本软件   否：退出
        IfMsgBox yes
        {
...
;设置需要添加的游戏
  ...
  ;~h::
  MButton::
    ;if WinActive("异环") or WinActive("幻塔")
    {
      {
  ...
  myCoffeeHelp:
    ...
    Text:="|<f店长特供 字样>*119$69."
    ok:=FindText(X:="wait", Y:=10, 1939, 900, 3189, 1410, 0.1, 0.1, Text)
    if (ok)
    {
      send {f down}
      sleep 20
    ...
    t1:=A_TickCount, Text:=X:=Y:=""
    Text:="|<右下角开始>*123$71."
    ok:=FindText(X:="wait", Y:=10, 3163, 1902, 3758, 2119, 0.1, 0.1, Text)
    if (ok)
    {
      FindText().Click(X, Y, "L")
    }
    ...
    sleep 250
    FindText().Click(3437, 2010, "L")

    loop, 30
    {
      sleep 1000
      FindText().Click(188, 904, "L")

      t1:=A_TickCount, Text:=X:=Y:=""
      Text:="|<第三颗星星>*131$71."
      if (ok:=FindText(X, Y, 3592, 568, 3722, 680, 0.1, 0.1, Text))
      {
        Break
      }
    }
    ...
    sleep 200
    FindText().Click(92, 95, "L")

    sleep 1000
    FindText().Click(2327, 1672, "L")
  return
  ...
  tabClickQueRen:
    ...
    Text:="|<屏幕中间的确认>*124$71.|<地图右下角的传送按钮>*123$70.|<角色圣遗物右下角强化>*123$71."
    if (ok:=FindText(X, Y, 1289, 1, 3837, 2157, 0, 0, Text))
    {
      FindText().Click(X, Y, "L")
    }else{
      ; 点击右下角
  ...
  +tab::
    t1:=A_TickCount, Text:=X:=Y:=""
    Text:="|<右上角的跳过>*147$71."

    if (ok:=FindText(X, Y, 3058, 0, 3838, 343, 0, 0, Text))
    {
      FindText().Click(X, Y, "L")
    }
  ; sleep 400
